...
public class RequiredResult implements ValidationResult {
	 ...
	 */
	public RequiredResult(boolean valid, String fieldName, LangParam<?> lang) throws ValidationConfigNotFound {
		super();
		this.valid = valid;
		this.fieldName = fieldName;
		this.message = Nationalization.getTranslation(Nationalization.REQUIRED_ERROR_KEY, lang);
	}
